...
// The registry starts with no series rows; each family stage adds its own row
// and its own `use()`d install in the same object (4.2 scatter, 4.3 line, 4.4
// heatmap, 4.5 line, 4.6 bar, 4.7 radar).
